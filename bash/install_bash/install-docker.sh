...
docker push 172.30.0.3:5000/centos/postgresql-95-centos7
docker push 172.30.0.3:5000/centos/mysql-57-centos7
docker push 172.30.0.3:5000/centos/php-70-centos7
docker push 172.30.0.3:5000/gogs/gogs:0.11.4
docker push 172.30.0.3:5000/sonatype/nexus:2.14.4
docker push 172.30.0.3:5000/sonarqube:6.3.1
docker push 172.30.0.3:5000/marvambass/subversion
docker push 172.30.0.3:5000/nginx:1.13
